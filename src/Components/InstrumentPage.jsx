...
import imgGermanFingeringC from '../Images/german_fingering_c_recorders.jpg';
    ...
    function getImage(instrument) {
        ...
        switch (instrumentNameLower) {
            ...
            case 'a:baroque_fingering_f_recorders':
                ...
                break;
            case 'a:german_fingering_c_recorders':
                result = imgGermanFingeringC;
                break;
            ...
            case 'a:notes_on_a_piano_keyboard':
                ...
                break;
            case 'a:drum_patterns':
                result = imgDrumPatterns;
                break;
            case 'a:rock_fills':
                result = imgRockFills;
                break;
